...
public class CardCollection implements UserInterface {
    ...
    public void addCardToCollection(String cardName) {
        ...
        if (card != null) {
            ...
            System.out.println("Error addCardToCollection CardCollection: La carta no se encuentra entre las cartas disponibles.");
        }
    }
    ...
    public void showCardType(String cardName) {
        ...
        if (card != null) {
            ...
            System.out.println("Error showCardType: La carta no se encuentra entre las cartas disponibles.");
        }
    }
